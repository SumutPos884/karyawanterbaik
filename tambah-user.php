...
if(isset($_POST['submit'])):			
	...
	if(empty($errors)):
		$pass = sha1($password);
		$simpan = mysqli_query($koneksi,"INSERT INTO user (id_user, username, password, nama, email, role, security_answer) VALUES ('', '$username', '$pass', '$nama', '$email', '$role', '$security_answer')");
		if($simpan) {
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" name="security_answer" required class="form-control"/>
				</div>
			</div>
		</div>
