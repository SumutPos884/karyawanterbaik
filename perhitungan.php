...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color: #4B0082;"><i class="fa fa-table"></i> Matrix Keputusan (X)</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color: #4B0082;"><i class="fa fa-table"></i> Matriks Ternormalisasi (R)</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color: #4B0082;"><i class="fa fa-table"></i> Bobot Preferensi (W)</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color: #4B0082;"><i class="fa fa-table"></i> Perhitungan (V))</h6>
    </div>
