...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/logo ku.png" type="image/x-icon">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar"> <!-- Updated here -->

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-left" href="index.php">
        <img src="assets/img/sumut1.jpeg" alt="KU" width="100" height="50"/>
    ...
    <li class="nav-item <?php if($page == "Alternatif"){echo "active";} ?>">
        ...
        <li class="nav-item <?php if($page == "data_jabatan"){echo "active";} ?>">
        <a class="nav-link" href="data_jabatan.php">
          <i class="fas fa-fw fa-users"></i>
    ...
    <li class="nav-item <?php if($page == "Hasil"){echo "active";} ?>">
        <a class="nav-link" href="hasil2.php">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Data Hasil Akhir</span></a>
      </li> 
